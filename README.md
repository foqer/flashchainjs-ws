# Flashchain websocket interface (flashchainjs-ws)

Pure JavaScript Flashchain websocket library for node.js and browsers. Can be used to easily connect to and obtain data from the Flashchain blockchain via public apis or local nodes.
...
```
<script type="text/javascript" src="https://cdn.rawgit.com/flashchain/flashchainjs-ws/build/flashchainjs-ws.js" />
```

A variable flashchain_ws will be available in window.
...
This is a non-exhaustive list of endpoints available from the witness_node executable, which provides the API server of Flashchain.

## database_api
https://github.com/foqer/flashchain-core/blob/master/libraries/app/database_api.cpp
